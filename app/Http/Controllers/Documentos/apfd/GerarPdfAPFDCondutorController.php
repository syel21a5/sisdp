...
class GerarPdfAPFDCondutorController extends Controller
{
    public function gerarPdfAPFDCondutor(Request $request)
    {
        $request->validate([
            'conteudo' => 'required',
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'apfd-condutor-' . date('Y-m-d-His') . '.pdf');
    }

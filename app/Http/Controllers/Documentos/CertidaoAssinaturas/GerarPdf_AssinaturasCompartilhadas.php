...
class GerarPdf_AssinaturasCompartilhadas extends Controller
{
    public function gerarPdfAssinaturasCompartilhadas(Request $request)
    {
        $request->validate([
            'conteudo' => 'required',
        ...
        // ✅ MODIFICAR O HTML PARA USAR OS DADOS PROCESSADOS
        $html = '
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'certidao-assinatura-' . date('Y-m-d-His') . '.pdf');
    }

...
class GerarPdfAAFAICondutorController extends Controller
{
    public function gerarPdfAAFAICondutor(Request $request)
    {
        $request->validate([
            'conteudo' => 'required',
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'aafai-condutor-' . date('Y-m-d-His') . '.pdf');
    }

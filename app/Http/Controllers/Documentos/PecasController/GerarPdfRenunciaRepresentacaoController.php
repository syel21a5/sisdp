<?php
// arquivo: app/Http/Controllers/Documentos/PecasController/GerarPdfRenunciaRepresentacaoController.php
...
class GerarPdfRenunciaRepresentacaoController extends Controller
{
    public function gerarPdfRenunciaRepresentacao(Request $request)
    {
        ...
        <head>
            ...
            <style>
                ...
                /* Estilos para preservar as fontes personalizadas */
                ...
                /* Estilos para preservar os tamanhos personalizados */
        ...
        <body>
            <div class="header">
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 5px;">
                    <tr>
                        <td style="width: 100px; vertical-align: middle; text-align: center; padding: 0 10px;">
                            ' . ($image1Base64 ? '<img src="' . $image1Base64 . '" style="width: 100px; height: 100px; object-fit: contain; margin-top: -5px;" alt="Brasão PE">' : '') . '
                        </td>
                        ...
                        <td style="width: 100px; vertical-align: middle; text-align: center; padding: 0 10px;">
                            ' . ($image2Base64 ? '<img src="' . $image2Base64 . '" style="width: 100px; height: 100px; object-fit: contain; margin-top: -5px;" alt="Brasão PCPE">' : '') . '
                        </td>
                    </tr>
                </table>
            </div>
        ...
        return PdfService::generatePdf($html, 'termo-renuncia-representacao-' . date('Y-m-d-His') . '.pdf');
    }

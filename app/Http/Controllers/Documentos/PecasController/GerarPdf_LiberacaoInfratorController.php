...
class GerarPdf_LiberacaoInfratorController extends Controller
{
    public function gerarPdfLiberacaoInfrator(Request $request)
    {
        ...
        $request->validate([
            ...
            // ADICIONE CAMPOS ESPECÍFICOS DO NOVO TERMO SE PRECISAR
        ]);
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'termo-liberacao-infrator-' . date('Y-m-d-His') . '.pdf');
    }

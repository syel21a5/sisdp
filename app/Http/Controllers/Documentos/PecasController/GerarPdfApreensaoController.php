...
class GerarPdfApreensaoController extends Controller
{
    public function gerarPdfApreensao(Request $request)
    {
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'termo-apreensao-' . date('Y-m-d-His') . '.pdf');
    }

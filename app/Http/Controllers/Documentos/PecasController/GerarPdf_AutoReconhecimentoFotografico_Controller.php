...
class GerarPdf_AutoReconhecimentoFotografico_Controller extends Controller
{
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'auto-reconhecimento-fotografico-' . date('Y-m-d-His') . '.pdf');
    }
}
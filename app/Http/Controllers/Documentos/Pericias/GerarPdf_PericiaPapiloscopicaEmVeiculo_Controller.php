...
class GerarPdf_PericiaPapiloscopicaEmVeiculo_Controller extends Controller
{
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return PdfService::generatePdf($html, 'oficio-pericia-papiloscopica-veiculo-' . date('Y-m-d-His') . '.pdf');
    }
}

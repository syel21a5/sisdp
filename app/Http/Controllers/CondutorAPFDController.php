...
class CondutorAPFDController extends Controller
{
    public function pesquisar(Request $request)
    {
        $request->validate([
            'filtro' => 'sometimes|in:Nome,CPF,RG,Alcunha',
    ...
    public function salvar(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao cadastrar condutor: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function atualizar(Request $request, $id)
    {
        ...
        try {
            ...
            if ($afetados === 0) {
                return response()->json([
                    'success' => false,
                    'message' => 'Condutor não encontrado ou sem alterações'
                ], 404);
            }
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao atualizar condutor: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function excluir($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao excluir condutor: ' . $e->getMessage()
            ], 500);
        }
    }

...
class Testemunha1Controller extends Controller
{
    ...
    public function buscar($id)
    {
        ...
        if (!$registro) {
            return response()->json([
                'success' => false,
                'message' => 'Testemunha não encontrada'
            ], 404);
        }
    ...
    public function salvar(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Testemunha cadastrada com sucesso',
                'id' => $id
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Erro ao cadastrar testemunha: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function atualizar(Request $request, $id)
    {
        ...
        try {
            ...
            if ($afetados === 0) {
                return response()->json([
                    'success' => false,
                    'message' => 'Testemunha não encontrada ou sem alterações'
                ], 404);
            }

            return response()->json([
                'success' => true,
                'message' => 'Testemunha atualizada com sucesso'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
                'message' => 'Erro ao atualizar testemunha: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function excluir($id)
    {
        try {
            ...
            if ($deleted) {
                return response()->json([
                    'success' => true,
                    'message' => 'Testemunha excluída com sucesso'
                ]);
            }
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao excluir testemunha: ' . $e->getMessage()
            ], 500);
        }
    }

/**
 * JS para Ofício Família APFD Dinâmico utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO FAMÍLIA APFD...');
    ...
    DocumentoService.gerar('/oficiofamilia-apfd', dadosParaEnviar);
}

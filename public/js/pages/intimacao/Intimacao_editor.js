...
function cleanHtmlContent(html) {
    ...
    // 10. Preservar a linha de corte entre as vias
    html = html.replace(/<div class="linha-corte"><\/div>/g, '<div class="linha-corte"></div>');
...
function printDocument() {
    ...
    form.method = 'POST';
    form.action = '/intimacao'; // ✅✅✅ ATUALIZADO: removido /pdf
    form.target = '_blank';

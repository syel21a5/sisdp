console.log('🔵 AAFAI CONDUTOR - JavaScript específico carregado');

// Identificar número de autores pela URL
const currentPath = window.location.pathname;

if (currentPath.includes('3autores')) {
    window.documentType = 'AAFAI_CONDUTOR_3AUTORES';
    console.log('🔵 Versão: AAFAI Condutor 3 Autores');
} else if (currentPath.includes('2autores')) {
    window.documentType = 'AAFAI_CONDUTOR_2AUTORES';
    console.log('🔵 Versão: AAFAI Condutor 2 Autores');
} else {
    window.documentType = 'AAFAI_CONDUTOR_1AUTOR';
    console.log('🔵 Versão: AAFAI Condutor 1 Autor');
}
// FIM DA ADIÇÃO
...
function printDocument() {
    console.log('🔵 GERANDO PDF AAFAI CONDUTOR...');

/**
 * JS para Perícia de Confrontação Papiloscópica utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE PERÍCIA DE CONFRONTAÇÃO PAPILOSCÓPICA...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/pericia-papiloscopica-confrontacao-pdf';

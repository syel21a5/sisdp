/**
 * JS para Exame Preliminar de Entorpecentes utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE EXAME PRELIMINAR DE ENTORPECENTES...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/exame-preliminar-entorpecentes-pdf';

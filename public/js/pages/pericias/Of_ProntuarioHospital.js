/**
 * JS para Ofício de Prontuário Hospitalar utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO - PRONTUÁRIO HOSPITALAR...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/oficio-prontuario-hospitalar-pdf';

/**
 * JS para Ofício de Perícia Documentoscópica utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO - PERÍCIA DOCUMENTOSCÓPICA...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/pericia-documentoscopica-pdf';

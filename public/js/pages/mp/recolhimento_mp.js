...
function cleanHtmlContent(html) {
    ...
    // Remover qualquer marcador de quebra de página para manter 1 página
    html = html.replace(/--- QUEBRA DE PÁGINA ---/g, '');
    html = html.replace(/<p class="page-break-marker"[^>]*>--- QUEBRA DE PÁGINA ---<\/p>/g, '');
...
function printDocument() {
    ...
    form.method = 'POST';
    form.action = '/recolhimento-mp'; // ✅ CORRIGIDO: Rota POST correta
    form.target = '_blank';

/**
 * JS para Ofício Recolhimento MP utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE RECOLHIMENTO MP...');
    ...
    const dadosParaEnviar = {
        ...
        'numero_oficio': dados.numero_oficio || 'NÃO GERADO',
        'conteudo': content,
    ...
    DocumentoService.gerar('/recolhimento-mp', dadosParaEnviar);
}

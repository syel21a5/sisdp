/**
 * JS para CI de Remessa de Procedimentos utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE CI - REMESSA DE PROCEDIMENTO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/ci-remessa-procedimentos-pdf';

/**
 * JS para Termo de Guarda e Entrega de Veículo utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE TERMO DE GUARDA E ENTREGA DE VEÍCULO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/termo-guarda-veiculo-pdf';

/**
 * JS para Ofício de Comunicação a Advogado utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO - COMUNICAÇÃO A ADVOGADO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/oficio-comunica-advogado-pdf';

/**
 * JS para Certidão de Mídias em Nuvem (Drive) utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE CERTIDAO DE MIDIAS EM NUVEM...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/certidao-midias-drive-pdf';

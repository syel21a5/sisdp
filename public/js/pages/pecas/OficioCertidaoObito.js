/**
 * JS para Ofício de Solicitação de Certidão de Óbito utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO PARA CERTIDÃO DE ÓBITO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/oficio-certidao-obito-pdf';

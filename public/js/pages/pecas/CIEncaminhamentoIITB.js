/**
 * JS para CI de Encaminhamento ao IITB utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE CI - ENCAMINHAMENTO IITB...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/ci-encaminhamento-iitb-pdf';

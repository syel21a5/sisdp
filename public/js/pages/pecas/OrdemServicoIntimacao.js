/**
 * JS para Ordem de Serviço - Intimação utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DA ORDEM DE SERVIÇO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/ordem-servico-intimacao-pdf';

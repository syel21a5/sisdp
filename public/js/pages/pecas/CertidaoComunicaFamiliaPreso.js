/**
 * JS para Certidão de Comunicação à Família utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE CERTIDÃO DE COMUNICAÇÃO À FAMÍLIA...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/certidao-comunica-familia-preso-pdf';

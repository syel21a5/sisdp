/**
 * JS para Termo de Autorização para Extração de Dados utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE TERMO - AUTORIZAÇÃO EXTRAÇÃO DE DADOS...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/termo-autorizacao-dados-pdf';

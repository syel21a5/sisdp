/**
 * JS para Auto de Reconhecimento Fotográfico utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE AUTO DE RECONHECIMENTO FOTOGRÁFICO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/auto-reconhecimento-fotografico-pdf';

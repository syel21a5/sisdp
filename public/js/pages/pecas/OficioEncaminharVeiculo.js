/**
 * JS para Ofício Encaminhar Veículo CIRETRAN utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE OFÍCIO - ENCAMINHAR VEÍCULO...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/oficio-encaminhar-veiculo-pdf';

/**
 * JS para CI de Remessa de Objetos e Documentos utilizando TinyMCE 6 e DocumentoService
 */

function printDocument() {
    console.log('🟢 GERANDO PDF DE CI - REMESSA DE OBJETOS/DOCUMENTOS...');
    
    const dados = window.dadosParaImpressao || {};
    const content = tinymce.activeEditor.getContent();

    const endpoint = '/ci-remessa-objetos-documentos-pdf';

    ...
    <div class="editor-wrapper">
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                <p class="ql-align-center" style="background-color: #d0d0d0; padding: 6px 10px; font-weight: bold; border: 1px solid #000;">DESPACHO</p>
                <p class="preservar-espacamento"><br></p>
                <p class="ql-align-justify" style="text-align: justify;">Senhor Escrivão(ã), junte aos autos a(s) peça(s) abaixo relacionada(s):</p>
                ...
                <p class="ql-align-justify" style="text-align: justify;">Em seguida, remeta-se os Autos à Justiça para as demais providências legais pertinentes.</p>
                <p class="ql-align-center" style="text-align: center;"><strong>CUMPRA-SE</strong></p>
                <p class="ql-align-center" style="text-align: center;">[CIDADE], [DATA]</p>
                <p class="ql-align-center" style="text-align: center;"><strong>[DELEGADO]</strong></p>
                <p class="ql-align-center" style="text-align: center;">Delegado(a) de Polícia</p>

                <div class="page-break" style="page-break-before: always;"></div>

                <p class="ql-align-center" style="background-color: #d0d0d0; padding: 6px 10px; font-weight: bold; border: 1px solid #000;">DATA</p>
                <p class="ql-align-center" style="text-align: center;">Ao(s) [DATA], recebo estes autos do(a) Delegado(a)</p>
                <p class="ql-align-center" style="text-align: center;">que preside o presente Inquérito. Do que, para constar, lavro este termo.</p>
                <p class="ql-align-center" style="text-align: center;">Eu, _________________, Escrivão(ã) que o digitei.</p>

                <p class="ql-align-center" style="background-color: #d0d0d0; padding: 6px 10px; font-weight: bold; border: 1px solid #000;">JUNTADA</p>
                <p class="ql-align-center" style="text-align: center;">Ao(s) [DATA], faço juntada dos documentos</p>
                <p class="ql-align-center" style="text-align: center;">que adiante se seguem. Do que, para constar, lavro este termo.</p>
                <p class="ql-align-center" style="text-align: center;">Eu, _________________, Escrivão(ã) que o digitei.</p>

                <p class="ql-align-center" style="background-color: #d0d0d0; padding: 6px 10px; font-weight: bold; border: 1px solid #000;">CERTIDÃO</p>
                <p class="ql-align-center" style="text-align: center;">Certifico, que nesta data, dei fiel cumprimento ao</p>
                <p class="ql-align-center" style="text-align: center;">despacho retro do Delegado(a) que preside o presente Inquérito, aonde me reporto e DOU FÉ.</p>
                <p class="ql-align-center" style="text-align: center;">Eu, _________________, Escrivão(ã) que o digitei.</p>

                <div class="page-break" style="page-break-before: always;"></div>

                <p class="ql-align-center" style="background-color: #d0d0d0; padding: 6px 10px; font-weight: bold; border: 1px solid #000;">CONCLUSÃO</p>
                <p class="ql-align-center" style="text-align: center;">Ao(s) [DATA], faço estes autos conclusos</p>
                <p class="ql-align-center" style="text-align: center;">ao(a) Delegado(a) desta [DELEGACIA], do que para constar, lavro este termo.</p>
                <p class="ql-align-center" style="text-align: center;">Eu, __________________ Escrivão(ã) que o digitei.</p>
            </div>

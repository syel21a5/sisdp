    ...
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor do AUTO do TERMO DE AVALIAÇÃO INDIRETA
            </h1>
        </div>

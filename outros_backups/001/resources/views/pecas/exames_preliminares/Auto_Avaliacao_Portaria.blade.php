...
<body class="body-declaracao">
    ...
    <p style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: justify;">
        <span style="font-family: Arial, sans-serif; font-size: 12pt;">
            ...
            <b>AVALIAÇÃO DE OBJETOS</b>, nomeia como Peritos: <strong>{{ !empty($dadosArray['policial_1']) ? $dadosArray['policial_1'] : 'NÃO INFORMADO' }}</strong> e
    ...
    <p style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: justify;">
        <span style="font-family: Arial, sans-serif; font-size: 12pt;">
            ...
            procederem a <b>AVALIAÇÃO DE OBJETOS</b> do procedimento policial em questão.

...
<ul class="nav nav-tabs mt-1" id="subAbasVeiculo" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#controle-veiculo" role="tab">
            <i class="bi bi-calendar-check me-1"></i> Controle de Veículos
        </a>
    </li>
</ul>
...
<div class="tab-content mt-2">
                ...
                <form id="formVeiculo">
                    ...
                    <div class="row g-2 mb-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" placeholder="SEI" name="sei" id="inputSeiVeiculo">
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm mt-3">
            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-striped table-hover" id="tabelaResultadosVeiculo">
    ...
    <div class="tab-pane fade" id="controle-veiculo" role="tabpanel">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white py-2">
                <h5 class="mb-0"><i class="bi bi-calendar-check me-2"></i>Controle de Veículos por Status</h5>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="alert alert-info d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Visualize os veículos agrupados por status. Clique em um status para ver os detalhes.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-striped table-hover" id="tabelaControleVeiculo">
                        <thead class="table-light">
                            <tr>
                                <th>STATUS</th>
                                <th>QUANTIDADE</th>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-primary text-white">
                                <h5 class="modal-title" id="modalDetalhesStatusTitulo">Detalhes dos Veículos</h5>

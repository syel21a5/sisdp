...
<ul class="nav nav-tabs mt-1" id="subAbasCelular" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#controle-celular" role="tab">
            <i class="bi bi-calendar-check me-1"></i> Controle de Celulares
        </a>
    </li>
</ul>
...
<div class="tab-content mt-2">
            ...
            <div class="card-body py-3">
                <form id="formCelular">
                    ...
                    <div class="row g-2 mb-2">
                        ...
                        <div class="col-md-3">
                            <label for="inputProcessoCelular" class="form-label">Processo</label>
                            <input type="text" class="form-control" placeholder="PROCESSO" name="processo" id="inputProcessoCelular">
                        </div>
                    </div>
        ...
        <div class="card border-0 shadow-sm mt-3">
            ...
            <div class="card-body py-3">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-striped table-hover" id="tabelaResultadosCelular">
    ...
    <div class="tab-pane fade" id="controle-celular" role="tabpanel">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white py-2">
                <h5 class="mb-0"><i class="bi bi-calendar-check me-2"></i>Controle de Celulares por Status</h5>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="alert alert-info d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Visualize os celulares agrupados por status. Clique em um status para ver os detalhes.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-danger text-white">
                            <div class="card-body text-center py-3">
                                <h4 class="card-title mb-1" id="contador-apreendido">0</h4>
                                <p class="card-text mb-0">Apreendidos</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-success text-white">
                            <div class="card-body text-center py-3">
                                <h4 class="card-title mb-1" id="contador-devolvido">0</h4>
                                <p class="card-text mb-0">Devolvidos</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-warning text-dark">
                            <div class="card-body text-center py-3">
                                <h4 class="card-title mb-1" id="contador-analise">0</h4>
                                <p class="card-text mb-0">Em Perícia</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-striped table-hover" id="tabelaControleCelular">
                        <thead class="table-light">
                            <tr>
                                <th>STATUS</th>
                                <th>QUANTIDADE</th>
                ...
                <div class="modal fade" id="modalDetalhesStatus" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-primary text-white">
                                <h5 class="modal-title" id="modalDetalhesStatusTitulo">Detalhes dos Celulares</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div id="conteudoDetalhesStatus">

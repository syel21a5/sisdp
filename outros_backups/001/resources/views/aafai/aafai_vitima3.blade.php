...
<head>
    ...
    <title>AAFAI VÍTIMA 3 - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    <script>
        ...
        console.log('Dados carregados para AAFAI Vítima 3:', window.dadosParaImpressao);
    </script>

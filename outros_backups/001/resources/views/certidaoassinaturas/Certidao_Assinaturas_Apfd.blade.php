        ...
        <div class="editor-area">
            ...
            <div style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: left;">
                <p style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: justify;">
                    <strong>NOME</strong>: {{ !empty($dadosArray['condutor']['nome']) ? $dadosArray['condutor']['nome'] : 'NÃO INFORMADO' }},
                    <strong>ALCUNHA</strong>: {{ !empty($dadosArray['condutor']['alcunha']) ? $dadosArray['condutor']['alcunha'] : 'NÃO INFORMADO' }},
                    <strong>NASCIMENTO</strong>: {{ !empty($dadosArray['condutor']['nascimento']) ? $dadosArray['condutor']['nascimento'] : 'NÃO INFORMADO' }},
                    <strong>IDADE</strong>: {{ !empty($dadosArray['condutor']['idade']) ? $dadosArray['condutor']['idade'] : 'NÃO INFORMADO' }},
                    <strong>ESTADO CIVIL</strong>: {{ !empty($dadosArray['condutor']['estcivil']) ? $dadosArray['condutor']['estcivil'] : 'NÃO INFORMADO' }},
                    <strong>NATURALIDADE</strong>: {{ !empty($dadosArray['condutor']['naturalidade']) ? $dadosArray['condutor']['naturalidade'] : 'NÃO INFORMADO' }},
                    <strong>RG</strong>: {{ !empty($dadosArray['condutor']['rg']) ? $dadosArray['condutor']['rg'] : 'NÃO INFORMADO' }},
                    <strong>CPF</strong>: {{ !empty($dadosArray['condutor']['cpf']) ? $dadosArray['condutor']['cpf'] : 'NÃO INFORMADO' }},
                    <strong>PROFISSÃO</strong>: {{ !empty($dadosArray['condutor']['profissao']) ? $dadosArray['condutor']['profissao'] : 'NÃO INFORMADO' }},
                    <strong>INSTRUÇÃO</strong>: {{ !empty($dadosArray['condutor']['instrucao']) ? $dadosArray['condutor']['instrucao'] : 'NÃO INFORMADO' }},
                    <strong>TELEFONE</strong>: {{ !empty($dadosArray['condutor']['telefone']) ? $dadosArray['condutor']['telefone'] : 'NÃO INFORMADO' }},
                    <strong>MÃE</strong>: {{ !empty($dadosArray['condutor']['mae']) ? $dadosArray['condutor']['mae'] : 'NÃO INFORMADO' }},
                    <strong>PAI</strong>: {{ !empty($dadosArray['condutor']['pai']) ? $dadosArray['condutor']['pai'] : 'NÃO INFORMADO' }},
                    <strong>ENDEREÇO</strong>: {{ !empty($dadosArray['condutor']['endereco']) ? $dadosArray['condutor']['endereco'] : 'NÃO INFORMADO' }}.
                </p>
                ...
                @if(!empty($dadosArray['vitimas']) && is_array($dadosArray['vitimas']))
                    @foreach($dadosArray['vitimas'] as $index => $vitima)
                        <p style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: justify;">
                ...
                @if(!empty($dadosArray['testemunhas']) && is_array($dadosArray['testemunhas']))
                    @foreach($dadosArray['testemunhas'] as $index => $testemunha)
                        <p style="line-height: 1.6; margin: 0.2em 0px; padding: 0px; text-align: justify;">
                ...
                @if(!empty($dadosArray['autores']) && is_array($dadosArray['autores']))
                    @foreach($dadosArray['autores'] as $index => $autor)
                        <p class="ql-align-justify preservar-espacamento">
                            <br>
                        </p>
                        ...
                        <p class="ql-align-justify">
                        {{-- Bloco ADVOGADO para cada autor --}}
                        <p class="ql-align-justify">
                            <br>
                        </p>

<!-- resources/views/mp/recolhimento3_mp.blade.php -->
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <title>OFÍCIO RECOLHIMENTO MP - Autor 3</title>
...
<body class="body-declaracao">
    ...
    if (!empty($dadosArray)) {
        if (!isset($dadosArray['autor3']) && isset($dadosArray['nome'])) {
            $dadosArray['autor3'] = [

...
<head>
    ...
    <title>OFÍCIOS MP - FAMÍLIA - Editor Profissional</title>
    ...
    <div class="editor-wrapper">
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                Em conformidade com o que estabelece o Art. 5º, Inciso LXII, da Constituição Federal, levo ao conhecimento de V.Sª. que, nesta data, nesta Cidade, em cumprimento ao Mandado de Prisão de Nº. <strong><?php echo exibirDado($dadosArray, 'nmandado'); ?></strong>, datado de <strong><?php echo exibirDado($dadosArray, 'datamandado'); ?></strong>, cuja cópia segue em anexo, expedido por esse MM. Juízo em desfavor de <strong><?php echo exibirDado($dadosArray, 'autor1', 'nome'); ?></strong>.
                </p>

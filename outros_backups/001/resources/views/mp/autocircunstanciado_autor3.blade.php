<!-- resources/views/mp/autocircunstanciado_autor3.blade.php -->
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <title>AUTO CIRCUNSTANCIADO - AUTOR 3 - Editor Profissional</title>
...
<div class="editor-wrapper">
    <div class="editor-header">
        <h1 class="editor-title"><i class="fas fa-file-contract"></i> Editor do AUTO CIRCUNSTACIADO - AUTOR 3</h1>
    </div>
    ...
    <div class="toolbar-container">
        <div class="toolbar-main">
            ...
            <div class="toolbar-right">
                <button class="btn-custom"><i class="fas fa-file-pdf"></i> Gerar PDF</button>
            </div>
        </div>
    </div>
...
// Sinaliza ao JS que o INTIMADO deve ser o Autor 3
window.autorAlvo = 3;
</script>

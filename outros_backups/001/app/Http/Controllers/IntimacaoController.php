...
class IntimacaoController extends Controller
{
    ...
    public function pesquisar(Request $request)
    {
        ...
        $registros = $query->where($filtro, 'LIKE', "%{$termo}%")
            ->orderBy('Nome', 'asc')
            ->limit(5)
            ->get(['id', 'data', 'data_comp', 'delegado', 'escrivao', 'delegacia', 'cidade', 'BOE', 'Nome', 'Tipo', 'Endereco', 'Telefone', 'dataoitiva', 'hora']);
    ...
    public function buscar($id)
    {
        ...
        $registro = $query->select(['id', 'data', 'data_comp', 'delegado', 'escrivao', 'delegacia', 'cidade', 'BOE', 'Nome', 'Tipo', 'Endereco', 'Telefone', 'dataoitiva', 'hora'])->first();
    ...
    public function controlePorPeriodo(Request $request)
    {
        ...
        $intimacoes = $intimacoesQuery->get(['id', 'data', 'data_comp', 'delegado', 'escrivao', 'delegacia', 'cidade', 'BOE', 'Nome', 'Endereco', 'Telefone', 'dataoitiva', 'hora']);

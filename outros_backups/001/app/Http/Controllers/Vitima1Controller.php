...
class Vitima1Controller extends Controller
{
    public function pesquisar(Request $request)
    {
        ...
        if ($filtro === 'CPF') {
            // Normaliza ambos os lados para busca por CPF com ou sem máscara
    ...
    public function salvar(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao cadastrar vítima: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function atualizar(Request $request, $id)
    {
        ...
        try {
            ...
            if ($afetados === 0) {
                return response()->json([
                    'success' => false,
                    'message' => 'Vítima não encontrada ou sem alterações'
                ], 404);
            }
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao atualizar vítima: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function excluir($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao excluir vítima: ' . $e->getMessage()
            ], 500);
        }
    }

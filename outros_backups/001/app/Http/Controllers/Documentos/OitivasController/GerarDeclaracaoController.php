    ...
    <style>
        ...
        @page {
            margin: 125px 30px 100px 30px; /* AUMENTADO: Margem superior de 105px para 125px
             /*                ↑↑↑            */
    /*         ESTE é o importante!  */
    /* Controla a distância mínima entre o texto e o rodapé */
        }
        body {
        ...
        .footer {
            position: fixed;
            bottom: -70px; /* ← AQUI: mudar -40px para -50px ou -60px ou -70px */
            left: 0;
            right: 0;
            text-align: center;
            font-size: 10pt;
...
<body>
    ...
    <div class="content">' . $dados['conteudo'] . '</div>
        ...
        return $dompdf->stream('declaracao-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

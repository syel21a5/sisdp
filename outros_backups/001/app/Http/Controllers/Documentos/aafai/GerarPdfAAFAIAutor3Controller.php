...
class GerarPdfAAFAIAutor3Controller extends Controller
{
    public function gerarPdfAAFAIAutor3(Request $request)
    {
        ...
        return $dompdf->stream('aafai-autor3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

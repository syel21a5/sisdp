...
class GerarPdfAAFAIVitima3Controller extends Controller
{
    public function gerarPdfAAFAIVitima3(Request $request)
    {
        ...
        return $dompdf->stream('aafai-vitima3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

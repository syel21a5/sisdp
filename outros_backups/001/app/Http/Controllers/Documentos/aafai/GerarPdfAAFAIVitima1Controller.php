...
class GerarPdfAAFAIVitima1Controller extends Controller
{
    public function gerarPdfAAFAIVitima1(Request $request)
    {
        ...
        return $dompdf->stream('aafai-vitima1-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

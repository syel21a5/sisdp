...
class GerarPdfAAFAIVitima2Controller extends Controller
{
    public function gerarPdfAAFAIVitima2(Request $request)
    {
        ...
        // ✅ NOME DO ARQUIVO PDF CORRETO
        return $dompdf->stream('aafai-vitima2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

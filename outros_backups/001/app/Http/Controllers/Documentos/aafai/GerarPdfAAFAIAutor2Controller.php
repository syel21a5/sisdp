...
class GerarPdfAAFAIAutor2Controller extends Controller
{
    public function gerarPdfAAFAIAutor2(Request $request)
    {
        ...
        return $dompdf->stream('aafai-autor2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

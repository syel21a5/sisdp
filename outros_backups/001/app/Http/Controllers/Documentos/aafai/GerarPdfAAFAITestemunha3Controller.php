...
class GerarPdfAAFAITestemunha3Controller extends Controller
{
    public function gerarPdfAAFAITestemunha3(Request $request)
    {
        ...
        return $dompdf->stream('aafai-testemunha3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

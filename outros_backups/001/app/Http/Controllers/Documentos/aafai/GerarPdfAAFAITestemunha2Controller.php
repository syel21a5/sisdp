...
class GerarPdfAAFAITestemunha2Controller extends Controller
{
    public function gerarPdfAAFAITestemunha2(Request $request)
    {
        ...
        return $dompdf->stream('aafai-testemunha2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

...
class GerarPdfAAFAITestemunha1Controller extends Controller
{
    public function gerarPdfAAFAITestemunha1(Request $request)
    {
        ...
        return $dompdf->stream('aafai-testemunha1-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

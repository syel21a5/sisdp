<?php
namespace App\Http\Controllers\Documentos\apfd;
...
class GerarPdfAPFDTestemunha2Controller extends Controller
{
    public function gerarPdfAPFDTestemunha2(Request $request)
    {
        ...
        // ✅ ALTEREI O NOME DO ARQUIVO PDF PARA TESTEMUNHA 2
        return $dompdf->stream('apfd-testemunha2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }
    ...
    // Função para limpar o conteúdo HTML (MANTIDA)
    private function cleanContent($content)
    {
        // MESMA LÓGICA DE LIMPEZA DO INTERROGATÓRIO
        $boms = [
            pack('H*','EFBBBF'),
            pack('H*','FFFE'),
            pack('H*','FEFF'),

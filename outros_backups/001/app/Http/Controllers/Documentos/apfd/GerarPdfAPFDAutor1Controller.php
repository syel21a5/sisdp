...
class GerarPdfAPFDAutor1Controller extends Controller
{
    public function gerarPdfAPFDAutor1(Request $request)
    {
        ...
        return $dompdf->stream('apfd-autor1-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

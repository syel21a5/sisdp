...
class GerarPdfAPFDVitima3Controller extends Controller
{
    public function gerarPdfAPFDVitima3(Request $request)
    {
        ...
        return $dompdf->stream('apfd-vitima3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

...
class GerarPdfAPFDAutor2Controller extends Controller
{
    public function gerarPdfAPFDAutor2(Request $request)
    {
        ...
        return $dompdf->stream('apfd-autor2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

...
class GerarPdfAPFDAutor3Controller extends Controller
{
    public function gerarPdfAPFDAutor3(Request $request)
    {
        ...
        // ✅ ALTEREI O NOME DO ARQUIVO PDF
        return $dompdf->stream('apfd-autor3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

...
class GerarPdfAPFDVitima1Controller extends Controller
{
    public function gerarPdfAPFDVitima1(Request $request)
    {
        ...
        return $dompdf->stream('apfd-vitima1-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

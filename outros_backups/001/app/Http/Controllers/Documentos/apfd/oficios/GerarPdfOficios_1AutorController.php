<?php
namespace App\Http\Controllers\Documentos\apfd\oficios; // ✅ CORRIGIDO: APFD → apfd
...
class GerarPdfOficios_1AutorController extends Controller
{
    /**
     * ✅ MÉTODO PARA VERSÃO COM FIANÇA
     */
    public function gerarPdfOficios1Autor(Request $request)
    {
        return $this->processarPdf($request, 'oficios-1autor-');
    }

    /**
     * ✅ MÉTODO PARA VERSÃO SEM FIANÇA
     */
    public function gerarPdfOficios1AutorSemFianca(Request $request)
    {
        return $this->processarPdf($request, 'oficios-1autor-sem-fianca-');
    }

    /**
     * ✅ MÉTODO PARA VERSÃO COM FIANÇA
     */
    public function gerarPdfOficios1AutorComFianca(Request $request)
    {
        return $this->processarPdf($request, 'oficios-1autor-com-fianca-');
    }

<?php
namespace App\Http\Controllers\Documentos\apfd\oficios;
...
class GerarPdfOficioFamiliaApfdController extends Controller
{
    /**
     * ✅ MÉTODO PRINCIPAL PARA GERAR PDF MP
     */
    public function gerarPdfOficioFamiliaMp(Request $request)
    {
        return $this->processarPdf($request, 'oficios-mp-');
    }

    public function gerarPdfOficioFamiliaApfd(Request $request)
    {
        return $this->processarPdf($request, 'oficiofamilia-apfd-');
    }

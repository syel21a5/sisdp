<?php
namespace App\Http\Controllers\Documentos\apfd\pecas; // ✅ CORRIGIDO: APFD → apfd
...
class GerarPdfNotadeCulpa_1AutorController extends Controller
{
    /**     
     */
    public function GerarPdfNotadeCulpa_1Autor(Request $request)
    {
        return $this->processarPdf($request, 'notadeculpa-1autor-');
    }

...
class GerarPdfNotadeCulpa_2AutorController extends Controller
{
    /**
     */
    public function GerarPdfNotadeCulpa_2Autor(Request $request)
    {
        return $this->processarPdf($request, 'notadeculpa-2autor-');
    }

...
class GerarPdfNotadeCulpa_3AutorController extends Controller
{
    /**
     */
    public function GerarPdfNotadeCulpa_3Autor(Request $request)
    {
        return $this->processarPdf($request, 'notadeculpa-3autor-');
    }

...
class GerarPdfAPFDTestemunha1Controller extends Controller
{
    public function gerarPdfAPFDTestemunha1(Request $request)
    {
        ...
        // ✅ ALTEREI O NOME DO ARQUIVO PDF PARA VÍTIMA 1
        return $dompdf->stream('apfd-testemunha1-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

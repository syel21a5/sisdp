...
class GerarPdfAPFDTestemunha3Controller extends Controller
{
    public function gerarPdfAPFDTestemunha3(Request $request)
    {
        ...
        return $dompdf->stream('apfd-testemunha3-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

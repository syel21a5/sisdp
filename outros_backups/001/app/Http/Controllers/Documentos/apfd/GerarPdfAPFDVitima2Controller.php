...
class GerarPdfAPFDVitima2Controller extends Controller
{
    public function gerarPdfAPFDVitima2(Request $request)
    {
        ...
        return $dompdf->stream('apfd-vitima2-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

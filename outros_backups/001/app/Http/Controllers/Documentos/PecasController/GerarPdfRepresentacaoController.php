...
class GerarPdfRepresentacaoController extends Controller
{
    public function gerarPdfRepresentacao(Request $request)
    {
        ...
        return $dompdf->stream('termo-representacao-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }
    ...
    private function cleanContent($content)
    {
        ...
        $content = ltrim($content, "?\xEF\xBB\xBF"); // Remove ? и BOM UTF-8 explícito

...
class GerarPdfRestituicaoController extends Controller
{
    public function gerarPdfRestituicao(Request $request)
    {
        ...
        return $dompdf->stream('termo-restituicao-' . date('Y-m-d-His') . '.pdf', [
            'Attachment' => false
        ]);
    }

...
class GerarPdfautocircunstanciadoController extends Controller
{
    /**
     */
    public function GerarPdfautocircunstanciado_1Autor(Request $request)
    {
        return $this->processarPdf($request, 'autocircunstanciado-1autor-');
    }

...
window.initIntimacaoIfPresent = function () {
    ...
    $('#btnProcessarBoeIntimacao').click(function () {
        ...
        if (pdfAtivo) {
            ...
            iniciarProgressoInt('🤖 A IA está lendo o PDF do BOE...');
        } else {
                    ...
                    <div class="card mb-2 border-0 shadow-sm">
                        <div class="card-body py-2">
                            <div class="row align-items-center">
                                <div class="col-md-2 text-truncate" title="${intimacao.dataIntimacao || 'N/A'}">
                                    <small class="text-muted">Intimação:</small><br>
                                    <strong class="small">${intimacao.dataIntimacao || 'N/A'}</strong>
                                </div>
                                <div class="col-md-2 text-truncate" title="${intimacao.boe || 'N/A'}">
                                    <small class="text-muted">BOE:</small><br>
                                    <strong class="small">${intimacao.boe || 'N/A'}</strong>
                                </div>
                                <div class="col-md-4 text-truncate" title="${intimacao.nome || 'N/A'}">
                                    <small class="text-muted">Nome:</small><br>
                                    <strong class="small">${intimacao.nome || 'N/A'}</strong>
                                </div>
                                <div class="col-md-2 text-truncate">
                                    <small class="text-muted">Data Oitiva:</small><br>
                                    <strong class="small">${intimacao.dataOitiva}</strong>
                                </div>
                                <div class="col-md-2 text-truncate">
                                    <small class="text-muted">Hora:</small><br>
                                    <strong class="small">${intimacao.hora || 'N/A'}</strong>
                                </div>
                            </div>
                        </div>
                    </div>

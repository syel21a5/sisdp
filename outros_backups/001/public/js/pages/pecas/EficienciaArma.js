...
function printDocument() {
    console.log('Iniciando geração de PDF - Eficiência Arma...');

    const dados = window.dadosParaImpressao || {};

    // ✅ DETECTAR SE É PORTARIA OU TERMO
    const isPortaria = window.location.pathname.includes('eficiencia-arma-portaria');
    const tipoDocumento = isPortaria ? 'portaria' : 'termo';
    ...
    // ✅ DEFINIR ROTA CORRETA BASEADA NO TIPO
    const formAction = isPortaria
        ? '/eficiencia-arma-portaria'
        : '/eficiencia-arma-termo';

...
function printDocument() {
    console.log('Iniciando geração de PDF - Avaliação...');

    const dados = window.dadosParaImpressao || {};

    // ✅ DETECTAR SE É PORTARIA OU TERMO
    const isPortaria = window.location.pathname.includes('avaliacao-portaria');
    ...
    const formAction = isPortaria
        ? '/termo-de-avaliacao-portaria'
        : '/termo-de-avaliacao-termo';

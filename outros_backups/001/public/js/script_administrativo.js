$(document).ready(function () {
    ...
    function importarBoeTexto() {
        ...
        function finalizarProgressoAdmin(sucesso) {
            ...
            $('#boeProgressBarAdmin').removeClass('progress-bar-animated progress-bar-striped bg-info bg-danger bg-success').addClass(cor).css('width', '100%').attr('aria-valuenow', 100);
            $('#boeProgressLabelAdmin').text(label);
        ...
        if (pdfAtivo) {
            ...
            $('#btnProcessarImportacaoBoe').prop('disabled', true).html('<i class="bi bi-cpu me-1"></i> Lendo PDF com IA...');
            iniciarProgressoAdmin('🤖 A IA está lendo o PDF...');
        } else {

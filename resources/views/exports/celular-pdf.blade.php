...
<head>
    <meta charset="UTF-8">
    <title>Relatório de Celulares Apreendidos</title>
    <style>
...
<div class="header">
    <div class="header-top">
        <div>
            ...
            <div class="subtitle">Relatório de Celulares Apreendidos</div>
        </div>
        <div class="meta">
...
<div class="table-wrapper">
    <div class="table-title">Listagem Detalhada de Celulares</div>
    <table>
        <thead>
            <tr>
                <th>#</th>
        ...
        <tbody>
            @if(count($registros) > 0)
                ...
                <tr>
                    ...
                    <td>{{ $r->pessoa }}</td>
                    <td>{{ $r->telefone }}</td>
                    <td style="font-family: monospace; font-size: 8px;">{{ $r->imei1 }}</td>
                    <td style="font-family: monospace; font-size: 8px;">{{ $r->imei2 }}</td>
                    <td>
                        @php
            ...
            @else
                <tr>
                    <td colspan="10" class="no-records">Nenhum celular encontrado no período informado.</td>
                </tr>
            @endif
        </tbody>
    </table>

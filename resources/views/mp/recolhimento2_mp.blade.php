<!-- resources/views/mp/recolhimento2_mp.blade.php -->
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
...
<body class="body-declaracao">
    ...
    if (!empty($dadosArray)) {
        ...
        foreach ($pessoas as $pessoa) {
            ...
            $dadosArray[$pessoa] = array_merge([
                'nome'=>'NÃO INFORMADO','alcunha'=>'NÃO INFORMADO','nascimento'=>'NÃO INFORMADO','idade'=>'NÃO INFORMADO',
                'estcivil'=>'NÃO INFORMADO','naturalidade'=>'NÃO INFORMADO','rg'=>'NÃO INFORMADO','cpf'=>'NÃO INFORMADO',
                'profissao'=>'NÃO INFORMADO','instrucao'=>'NÃO INFORMADO','telefone'=>'NÃO INFORMADO','mae'=>'NÃO INFORMADO',
                'pai'=>'NÃO INFORMADO','endereco'=>'NÃO INFORMADO'
            ], $dadosArray[$pessoa]);
        }
    }
    ...
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title"><i class="fas fa-file-contract"></i>Editor de OFÍCIO RECOLHIMENTO MP</h1>
        </div>
            ...
            <div class="document-header">
                <div class="header-content">
                    ...
                    <div class="header-text">
                        ...
                        <div class="delegacia-info"><?php echo exibirDado($dadosArray,'delegacia'); ?> – <?php echo exibirDado($dadosArray,'cidade'); ?></div>
                    </div>
    ...
    <script>
        window.dadosParaImpressao = {
            ...
            vitima1: <?php echo json_encode($dadosArray['vitima1'] ?? []); ?>,
            vitima2: <?php echo json_encode($dadosArray['vitima2'] ?? []); ?>,
            vitima3: <?php echo json_encode($dadosArray['vitima3'] ?? []); ?>,
            testemunha1: <?php echo json_encode($dadosArray['testemunha1'] ?? []); ?>,
            testemunha2: <?php echo json_encode($dadosArray['testemunha2'] ?? []); ?>,
            testemunha3: <?php echo json_encode($dadosArray['testemunha3'] ?? []); ?>,
            autor1: <?php echo json_encode($dadosArray['autor1'] ?? []); ?>,
            autor2: <?php echo json_encode($dadosArray['autor2'] ?? []); ?>,
            autor3: <?php echo json_encode($dadosArray['autor3'] ?? []); ?>
        };
    </script>

    <script>console.log('🟢 BLADE RECOLHIMENTO MP AUTOR2 CARREGADO');console.log('🟢 Rota:', '{{ request()->path() }}');console.log('🟢 Dados:', window.dadosParaImpressao);</script>

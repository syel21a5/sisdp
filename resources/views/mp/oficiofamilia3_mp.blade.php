...
<head>
    ...
    <title>OFÍCIOS MP - FAMÍLIA AUTOR3 - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    if (!empty($dadosArray)) {
        // ✅ ESTRUTURAR DADOS DO AUTOR3 SE CHEGAREM DE FORMA PLANA
    ...
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor de OFÍCIOS MP - FAMÍLIA (AUTOR3)
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                <!-- CONTEÚDO DO OFÍCIO FAMÍLIA PARA AUTOR3 -->
                ...
                Em conformidade com o que estabelece o Art. 5º, Inciso LXII, da Constituição Federal, levo ao conhecimento de V.Sª. que, nesta data, nesta Cidade, em cumprimento ao Mandado de Prisão de Nº. <strong><?php echo exibirDado($dadosArray, 'nmandado'); ?></strong>, datado de <strong><?php echo exibirDado($dadosArray, 'datamandado'); ?></strong>, cuja cópia segue em anexo, expedido por esse MM. Juízo em desfavor de <strong><?php echo exibirDado($dadosArray, 'autor3', 'nome'); ?></strong>.
                </p>
    ...
    <script>
        console.log('🟢 BLADE OFÍCIOS MP AUTOR3 CARREGADO');

...
<head>
    ...
    <title>OFÍCIOS MP - JUIZ, PROMOTOR, DEFENSOR - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor de OFÍCIOS MP - JUIZ, PROMOTOR, DEFENSOR
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p class="preservar-espacamento"><strong>JUIZ(A) DE DIREITO</strong></p>
                ...
                Em conformidade com o que preceitua o Art. 5º, Inciso LXII, da Constituição Federal, informo a V.Exª. que, nesta data, foi dado cumprimento ao Mandado de Prisão de Nº. <strong><?php echo exibirDado($dadosArray, 'nmandado'); ?></strong>, datado de <strong><?php echo exibirDado($dadosArray, 'datamandado'); ?></strong>, cuja cópia segue em anexo, expedido por esse MM. Juízo em desfavor de <strong><?php echo exibirDado($dadosArray, 'autor1', 'nome'); ?></strong>, que foi preso e recolhido ao xadrez desta unidade policial, a fim de aguardar por Audiência de Custódia. Seguem anexos, cópia do respectivo <strong>MANDADO DE PRISÃO</strong> com ciente do preso, bem como cópia do Auto de Exame de Lesão Corporal.
                </p>
                ...
                <!-- QUEBRA DE PÁGINA TINYMCE -->
                <div class="page-break"></div>

                <!-- SEGUNDO OFÍCIO (Promotor) - COMEÇA NA PÁGINA 2 -->
                <p class="preservar-espacamento ql-align-right">{{ !empty($dadosArray['cidade']) ? $dadosArray['cidade'] : 'NÃO INFORMADO' }}, {{ !empty($dadosArray['data_comp']) ? $dadosArray['data_comp'] : 'NÃO INFORMADO' }}</p>

                <p class="preservar-espacamento"><strong>Ofício nº {{ $numeroOficioPromotor ?? 'NÃO GERADO' }}</strong></p>

                <p class="preservar-espacamento"><br></p>

                <p class="preservar-espacamento"><strong>A SUA EXCELÊNCIA O(A) SENHOR(A)</strong></p>
                <p class="preservar-espacamento"><strong>PROMOTOR(A) DE JUSTIÇA</strong></p>
                <p class="preservar-espacamento"><strong>ESTADO DE PERNAMBUCO</strong></p>
                ...
                <p class="preservar-espacamento"><strong>Ofício nº {{ $numeroOficioDefensor ?? 'NÃO GERADO' }}</strong></p>

                <p class="preservar-espacamento"><br></p>

                <p class="preservar-espacamento"><strong>A SUA EXCELÊNCIA O(A) SENHOR(A)</strong></p>
                <p class="preservar-espacamento"><strong>DEFENSOR(A) PÚBLICO</strong></p>
                <p class="preservar-espacamento"><strong>ESTADO DE PERNAMBUCO</strong></p>
    ...
    <script src="{{ asset('js/pages/mp/oficios_mp.js')?v={{ time() }} }}?v=<?php echo time(); ?>"></script>

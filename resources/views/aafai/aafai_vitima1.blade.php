...
<head>
    ...
    <title>AAFAI VÍTIMA 1 - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    <script>
        ...
        console.log('Dados carregados para AAFAI Vítima 1:', window.dadosParaImpressao);
    </script>

    <!-- JavaScript principal - ATUALIZADO -->
    <script src="{{ asset('js/pages/aafai/aafai_vitima1.js') }}"></script>
</body>
</html>

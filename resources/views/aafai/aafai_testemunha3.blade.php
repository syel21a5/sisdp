...
<head>
    ...
    <title>AAFAI TESTEMUNHA 3 - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    <script>
        ...
        console.log('Dados carregados para AAFAI Testemunha 3:', window.dadosParaImpressao);
    </script>

    <!-- JavaScript principal - CAMINHO ALTERADO -->
    <script src="{{ asset('js/pages/aafai/aafai_testemunha3.js') }}"></script>
</body>
</html>

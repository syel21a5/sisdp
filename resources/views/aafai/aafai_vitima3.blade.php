...
<head>
    ...
    <title>AAFAI VÍTIMA - Editor Profissional</title>
...
<body class="body-declaracao">
    ...
    <script>
        ...
        console.log('Dados carregados para AAFAI VÍTIMA:', window.dadosParaImpressao);
    </script>
...
<script src="{{ asset('js/pages/aafai/aafai_vitima3.js')?v={{ time() }} }}"></script>
</body>
</html>

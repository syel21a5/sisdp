...
<head>
    ...
    <title>Auto de Apresentação e Apreensão - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor do AUTO DE APRESENTAÇÃO E APREENSÃO
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                <!-- CONTEÚDO DO AUTO DE APREENSÃO (ESPECÍFICO) -->
                <p style="text-align: center; line-height: 1.6; margin: 0.2em 0; padding: 0;">
                    <strong style="font-size: 20pt;">AUTO DE APRESENTAÇÃO E APREENSÃO</strong>
                </p>
                ...
                <p style="text-align: justify; line-height: 1.6; margin: 0.2em 0; padding: 0;">
                    ...
                    ao final assinado, aí compareceu o <strong>APRESENTADOR: {{ !empty($dadosArray['nome']) ? $dadosArray['nome'] : 'NÃO INFORMADO' }}</strong>,
                ...
                <div class="assinatura-area">
                    ...
                    <p style="line-height: 1.4; margin: 0.1em 0; padding: 0;">&nbsp;</p>
                    <p style="line-height: 1.4; margin: 0.1em 0; padding: 0;">Apresentador:</p>
                    <p style="line-height: 1.4; margin: 0.1em 0; padding: 0;">&nbsp;</p>
    ...
    <script src="{{ asset('js/pages/pecas/Apreensao.js') }}"></script>
</body>
</html>

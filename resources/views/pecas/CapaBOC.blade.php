...
<head>
    ...
    <title>Capa de BOC - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: CAPA DE BOC ({{ mb_strtoupper($dadosArray['capa_tipo'] ?? 'FLAGRANTE') }})
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p style="text-align: center; font-size: 16px; line-height: 1.5; margin: 20px 0 10px 0;">
                    <strong>BOLETIM DE OCORRÊNCIA CIRCUNSTANCIADO{{ isset($dadosArray['capa_tipo']) && $dadosArray['capa_tipo'] === 'Portaria' ? ' (PORTARIA)' : '' }}</strong><br>
                    <span style="font-size: 14px; font-weight: normal;">(Art. 173 Parágrafo único da Lei nº 8.069 de 13 de julho de 1990)</span>
                </p>

                <p style="text-align: center; font-size: 18px; margin-bottom: 30px;">
                    <strong>BOC Nº: _______________/______</strong>
                </p>
    ...
    <script src="{{ asset('js/pages/pecas/CapaBOC.js') }}?v={{ time() }}"></script>
</body>
</html>

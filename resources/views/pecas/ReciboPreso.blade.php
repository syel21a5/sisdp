...
<head>
    ...
    <title>Recibo de Entrega de Preso - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: RECIBO DE ENTREGA DE PRESO
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p style="text-align: center; font-size: 18px; line-height: 1.5; margin: 30px 0;">
                    <strong>RECIBO DE ENTREGA DE PRESO(A)</strong>
                </p>
                ...
                <p style="text-align: justify; line-height: 1.8; text-indent: 40px; margin-bottom: 30px;">
                    Recebi do(a) Condutor(a) <strong>{{ mb_strtoupper($dadosArray['recibo_condutor'] ?? 'NOME DO CONDUTOR') }}</strong>, o(s) preso(s) conduzido(s) de nome(s) <strong>{{ mb_strtoupper($dadosArray['recibo_autuado'] ?? 'NOME DO AUTUADO') }}</strong>, em perfeito estado físico, bem como os seus pertences arrecadados na ocorrência vinculada ao Boletim de Ocorrência em epígrafe, não restando nenhuma pendência por parte da guarnição responsável pela condução.
                </p>
                    ...
                    <table style="width: 100%; border: none;">
                        <tr>
                            <td style="width: 100%; text-align: center; border: none;">
                                ...
                                <strong>POLICIAL CIVIL PLANTONISTA</strong><br>
    ...
    <script src="{{ asset('js/pages/pecas/ReciboPreso.js') }}?v={{ time() }}"></script>
</body>
</html>

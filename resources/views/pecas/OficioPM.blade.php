...
<head>
    ...
    <title>Ofício - Requisição de Policial Militar - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: OFÍCIO - REQUISIÇÃO DE POLICIAL MILITAR
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    <p style="margin: 0;"><strong>Ao Ilustríssimo Senhor(a) Comandante do {{ mb_strtoupper($dadosArray['pm_batalhao'] ?? 'BATALHÃO DE POLÍCIA MILITAR') }}</strong></p>
                    <p style="margin: 0; margin-top: 5px;"><strong>Assunto:</strong> REQUISIÇÃO DE APRESENTAÇÃO DE POLICIAL MILITAR</p>
                ...
                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    Cumprimentando-o(a) cordialmente, sirvo-me do presente expediente para requisitar a Vossa Senhoria a apresentação do(s) Policial(is) Militar(es) abaixo relacionado(s), nesta Delegacia de Polícia Civil, 
                    <strong>no dia {{ $dadosArray['pm_data'] ?? '___/___/____' }}, às {{ $dadosArray['pm_hora'] ?? '___:___' }}</strong>, a fim de ser(em) ouvido(s) em Termo de Declarações para instruir as investigações referentes ao Boletim de Ocorrência em epígrafe:
                </p>

                <div style="margin-bottom: 30px; margin-left: 40px;">
                    {!! nl2br(e($dadosArray['pm_lista'] ?? 'NENHUM POLICIAL INFORMADO')) !!}
                </div>
    ...
    <script src="{{ asset('js/pages/pecas/OficioPM.js') }}?v={{ time() }}"></script>
</body>
</html>

...
<body class="body-declaracao">
    ...
    <div class="editor-wrapper">
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="height: 12px;"></div>
                <p style="text-align: justify;">
                    Em seguida, passaram os peritos a fazer os exames necessários, verificando os mecanismos de funcionamento da arma de fogo. Concluídas as pesquisas realizadas, responderam aos quesitos formulados da seguinte forma:
                </p>
                <p style="text-align: justify; margin-left: 20px;">
                    1º) <strong><span style="background-color: #ffff00;">[TIPO DE ARMA]</span></strong>;<br>
                    2º) <strong><span style="background-color: #ffff00;">[DADOS DA ARMA]</span></strong>;<br>
    ...
    <script src="{{ asset('js/pages/pecas/EficienciaArma.js') }}?v={{ time() }}"></script>
</body>
</html>

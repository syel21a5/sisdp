...
<head>
    ...
    <title>Termo de Restituição - Editor Profissional</title>    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
...
<body class="body-declaracao">
    ...
    <script src="{{ asset('js/pages/pecas/Restituicao.js') }}?v={{ time() }}"></script>
</body>
</html>

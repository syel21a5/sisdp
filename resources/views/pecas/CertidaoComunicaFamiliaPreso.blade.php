...
<head>
    ...
    <title>Certidão - Comunicação à Família - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: CERTIDÃO DE COMUNICAÇÃO À FAMÍLIA
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p style="text-align: center; font-size: 18px; line-height: 1.5; margin: 30px 0;">
                    <strong>CERTIDÃO DE COMUNICAÇÃO DE PRISÃO À FAMÍLIA</strong>
                </p>
                ...
                <p style="text-align: justify; line-height: 1.8; text-indent: 40px; margin-bottom: 30px;">
                    <strong>CERTIFICO</strong>, para os devidos fins de direito, e em cumprimento ao que determina a Constituição Federal, que nesta data, comuniquei a prisão e o local onde se encontra custodiado(a) o(a) autuado(a) <strong>{{ mb_strtoupper($dadosArray['comunicacao_autuado'] ?? 'NOME DO AUTUADO') }}</strong> ao(à) seu(sua) {{ $dadosArray['comunicacao_parentesco'] ?? 'Familiar' }}, Sr(a). <strong>{{ mb_strtoupper($dadosArray['comunicacao_familiar'] ?? 'NOME DO FAMILIAR') }}</strong>, {{ $dadosArray['comunicacao_meio'] ?? 'NÃO INFORMADO' }}, o(a) qual tomou ciência dos fatos ocorridos, relativos à ocorrência em epígrafe.
                </p>
    ...
    <script src="{{ asset('js/pages/pecas/CertidaoComunicaFamiliaPreso.js') }}?v={{ time() }}"></script>
</body>
</html>

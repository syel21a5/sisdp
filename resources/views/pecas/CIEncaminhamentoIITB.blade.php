...
<head>
    ...
    <title>C.I. - Encaminhamento IITB - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: COMUNICAÇÃO INTERNA - ENCAMINHAMENTO IITB
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    ...
                    <p style="margin: 0;"><strong>Ao:</strong> {{ mb_strtoupper($dadosArray['ci_destinatario'] ?? 'ILMO(A). DIRETOR(A) DO INSTITUTO DE IDENTIFICAÇÃO TAVARES BURIL – IITB') }}</p>
                    <p style="margin: 0; margin-top: 5px;"><strong>Assunto:</strong> ENCAMINHAMENTO PARA IDENTIFICAÇÃO CRIMINAL / PESQUISA</p>
                </div>
                ...
                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    Cumprimentando-o(a) cordialmente, sirvo-me do presente expediente para encaminhar a esse Instituto a pessoa de <strong>{{ mb_strtoupper($dadosArray['ci_pessoa_nome'] ?? 'NÃO INFORMADO') }}</strong>, 
                    {{ $dadosArray['ci_pessoa_qualificacao'] ?? 'sem qualificação adicional' }}, 
                    a fim de ser submetido(a) a Identificação Criminal e/ou Pesquisa Papiloscópica, em anexo a Ocorrência Policial nº {{ $dadosArray['boe'] ?? '_______' }}.
                </p>
    ...
    <script src="{{ asset('js/pages/pecas/CIEncaminhamentoIITB.js') }}?v={{ time() }}"></script>
</body>
</html>

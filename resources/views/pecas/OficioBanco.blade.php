...
<head>
    ...
    <title>Ofício - Instituição Financeira / Banco - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: OFÍCIO - INSTITUIÇÃO FINANCEIRA / BANCO
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    <p style="margin: 0;"><strong>Ao Ilustríssimo Senhor(a) Gerente da Agência do {{ mb_strtoupper($dadosArray['banco_nome'] ?? 'BANCO') }}</strong></p>
                    <p style="margin: 0;"><strong>Agência: {{ mb_strtoupper($dadosArray['banco_agencia'] ?? 'NÃO INFORMADA') }}</strong></p>
                    <p style="margin: 0; margin-top: 5px;"><strong>Assunto:</strong> SOLICITAÇÃO DE {{ mb_strtoupper($dadosArray['banco_solicitacao_tipo'] ?? 'INFORMAÇÕES') }}</p>
                ...
                <div style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    {!! nl2br(e($dadosArray['banco_texto'] ?? 'Cumprimentando-o(a) cordialmente, sirvo-me do presente para solicitar a V.Sa...')) !!}
                </div>

                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 30px;">
                    Salienta-se que a presente requisição fundamenta-se nas prerrogativas legais conferidas à Autoridade Policial para a condução de investigações criminais (art. 6º do CPP).
                </p>
    ...
    <script src="{{ asset('js/pages/pecas/OficioBanco.js') }}?v={{ time() }}"></script>
</body>
</html>

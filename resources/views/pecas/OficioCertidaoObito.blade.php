...
<head>
    ...
    <title>Ofício - Solicitação de Certidão de Óbito - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: OFÍCIO - CERTIDÃO DE ÓBITO
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    <p style="margin: 0;"><strong>Ao Ilustríssimo(a) Senhor(a) Titular do {{ mb_strtoupper($dadosArray['cartorio_nome'] ?? 'CARTÓRIO DO REGISTRO CIVIL') }}</strong></p>
                    <p style="margin: 0;"><strong>Comarca de {{ mb_strtoupper($dadosArray['cidade'] ?? 'NÃO INFORMADA') }}</strong></p>
                    <p style="margin: 0; margin-top: 5px;"><strong>Assunto:</strong> REQUISIÇÃO DE CERTIDÃO DE ÓBITO</p>
                ...
                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    Cumprimentando-o(a) cordialmente, sirvo-me do presente expediente para requisitar a Vossa Senhoria, a emissão e o envio a esta Delegacia de Polícia, com a máxima brevidade, de cópia da Certidão de Óbito referente a <strong>{{ mb_strtoupper($dadosArray['vitima_nome'] ?? 'NOME DA VÍTIMA') }}</strong>, falecido(a) nesta urbe, cujas circunstâncias da morte estão sendo apuradas através do Boletim de Ocorrência em epígrafe.
                </p>
    ...
    <script src="{{ asset('js/pages/pecas/OficioCertidaoObito.js') }}?v={{ time() }}"></script>
</body>
</html>

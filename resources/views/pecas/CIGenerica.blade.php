...
<head>
    ...
    <title>C.I. - Administrativa / Genérica - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: COMUNICAÇÃO INTERNA - ADMINISTRATIVA
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    ...
                    <p style="margin: 0;"><strong>Ao:</strong> {{ mb_strtoupper($dadosArray['ci_destinatario'] ?? 'DESTINATÁRIO NÃO INFORMADO') }}</p>
                    @if(!empty($dadosArray['ci_assunto']))
                    <p style="margin: 0; margin-top: 5px;"><strong>Assunto:</strong> {{ mb_strtoupper($dadosArray['ci_assunto']) }}</p>
                    @endif
                </div>
                ...
                <div style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    {!! nl2br(e($dadosArray['ci_corpo'] ?? 'Cumprimentando-o(a) cordialmente, sirvo-me do presente para informar/solicitar que...')) !!}
                </div>
    ...
    <script src="{{ asset('js/pages/pecas/CIGenerica.js') }}?v={{ time() }}"></script>
</body>
</html>

...
<head>
    ...
    <title>Recibo de Procedimento - Editor Profissional</title>
...
<body class="body-declaracao">
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p style="text-align: center; font-size: 18px; line-height: 1.5; margin: 30px 0;">
                    <strong>RECIBO DE PROCEDIMENTO</strong>
                </p>
                ...
                <p style="text-align: justify; line-height: 1.8; text-indent: 40px; margin-bottom: 30px;">
                    Recebi da {{ !empty($dadosArray['delegacia']) ? $dadosArray['delegacia'] : 'Delegacia de Polícia Civil' }}, nesta data, o Auto de Prisão em Flagrante Delito (APFD) e/ou Procedimento Policial referente ao Boletim de Ocorrência em epígrafe, {{ !empty($dadosArray['recibo_procedimento_obs']) ? $dadosArray['recibo_procedimento_obs'] . ', ' : '' }}para fins de encaminhamento ao(à) <strong>{{ mb_strtoupper($dadosArray['recibo_procedimento_destino'] ?? 'DESTINO') }}</strong>.
                </p>
                    ...
                    <table style="width: 100%; border: none;">
                        <tr>
                            <td style="width: 100%; text-align: center; border: none;">
                                ...
                                <strong>NOME DO RECEBEDOR:</strong> ________________________________________<br>
                                Matrícula/RG: ___________________
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <script src="{{ asset('js/pages/pecas/ReciboProcedimento.js') }}?v={{ time() }}"></script>
</body>
</html>

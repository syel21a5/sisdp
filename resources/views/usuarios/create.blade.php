                                                ...
                                                <div class="card mb-0">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_oficios" name="perm_oficios" {{ old('perm_oficios', true) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_oficios">Módulo Ofícios</label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_oitivas" name="perm_oitivas" {{ old('perm_oitivas', true) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_oitivas">Módulo Oitivas</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_pericias" name="perm_pericias" {{ old('perm_pericias', true) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_pericias">Módulo Perícias</label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_pecas" name="perm_pecas" {{ old('perm_pecas', true) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_pecas">Módulo Peças</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_preliminares" name="perm_preliminares" {{ old('perm_preliminares', true) ? 'checked' : '' }}>

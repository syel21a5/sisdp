                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm border-0 h-100" style="background-color: #f8f9fa;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check form-switch mb-2 fs-6">
                                        <input type="checkbox" class="form-check-input cursor-pointer" id="perm_copilot_ia" name="perm_copilot_ia" {{ old('perm_copilot_ia', true) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm border-0 h-100" style="background-color: #f8f9fa;">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr class="my-3 opacity-25">
                                    <div class="form-check form-switch mb-2 fs-6">
                                        <input type="checkbox" class="form-check-input cursor-pointer" id="perm_ver_apenas_proprias" name="perm_ver_apenas_proprias" {{ old('perm_ver_apenas_proprias', false) ? 'checked' : '' }}>

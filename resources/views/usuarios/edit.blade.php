                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card mb-0">
                                                    <div class="card-header">Grupo Documentos & Peças</div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_oficios" name="perm_oficios" {{ old('perm_oficios', $permOficios) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_oficios">Módulo Ofícios</label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_oitivas" name="perm_oitivas" {{ old('perm_oitivas', $permOitivas) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_oitivas">Módulo Oitivas</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_pericias" name="perm_pericias" {{ old('perm_pericias', $permPericias) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_pericias">Módulo Perícias</label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_pecas" name="perm_pecas" {{ old('perm_pecas', $permPecas) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_pecas">Módulo Peças</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-check mb-2">
                                                                    <input type="checkbox" class="form-check-input" id="perm_preliminares" name="perm_preliminares" {{ old('perm_preliminares', $permPreliminares) ? 'checked' : '' }}>
                                                                    <label class="form-check-label" for="perm_preliminares">Módulo Preliminares</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

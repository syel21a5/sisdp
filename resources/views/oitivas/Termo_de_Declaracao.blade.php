...
<head>
    ...
    <title>Termo de Declaração - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                <!-- CONTEÚDO DO TERMO DE DECLARAÇÃO -->
                ...
                <p style="text-align: justify; line-height: 1.6; margin: 0.2em 0; padding: 0;">
                    ...
                    <span style="background-color: cyan;">ESCREVER AQUI A DECLARAÇÃO</span>
                ...
                <div class="assinatura-area">
                    ...
                    <p style="line-height: 1.4; margin: 0.1em 0; padding: 0;">DECLARANTE:</p>
                    <p style="line-height: 1.4; margin: 0.1em 0; padding: 0;">&nbsp;</p>
    ...
    <script src="{{ asset('js/pages/oitivas/Declaracao.js') }}"></script>
</body>
</html>

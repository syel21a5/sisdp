...
<head>
    ...
    <title>Ofício - Perícia Documentoscópica - Editor Profissional</title>
...
<body class="body-declaracao">
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: OFÍCIO - PERÍCIA DOCUMENTOSCÓPICA
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <div style="margin-bottom: 30px; line-height: 1.5;">
                    ...
                    <p style="margin: 20px 0 0 0;"><strong>A(o):</strong> Ilmo(a). Sr(a). Chefe da Unidade Regional de Polícia Científica</p>
                    <p style="margin: 0;">Instituto de Criminalística</p>
                </div>

                <p style="text-align: left; line-height: 1.5; margin-bottom: 5px;">
                    <strong>ASSUNTO:</strong> Encaminhamento (Faz).
                </p>
                ...
                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    Através do presente, encaminho a V.Sª., para a realização de <strong>Perícia Documentoscópica</strong> e emissão do respectivo Laudo Pericial, os seguintes documentos: <strong>{{ $dadosArray['documentos_periciados'] ?? '________________________________' }}</strong>, relacionados com o procedimento em epígrafe e apreendidos conforme o Auto de Apresentação e Apreensão em apenso, com o fito de comprovar a materialidade delitiva ocorrida em {{ !empty($dadosArray['cidade']) ? $dadosArray['cidade'] : 'NÃO INFORMADO' }}-PE.
                </p>
                
                <p style="text-align: justify; line-height: 1.5; text-indent: 40px; margin-bottom: 15px;">
                    Esclareço que o autor/investigado do delito é a pessoa de <strong>{{ $dadosArray['autor_nome'] ?? '________________________________' }}</strong>.
                </p>
    ...
    <script src="{{ asset('js/pages/pericias/PericiaDocumentoscopica.js') }}?v={{ time() }}"></script>
</body>
</html>

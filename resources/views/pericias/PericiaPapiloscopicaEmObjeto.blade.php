...
<head>
    ...
    <title>Ofício de Perícia Papiloscópica em Objeto - Editor Profissional</title>
    ...
    <div class="editor-wrapper">
        <div class="editor-header">
            <h1 class="editor-title">
                ...
                Editor: PERÍCIA PAPILOSCÓPICA EM OBJETO
            </h1>
        </div>
        ...
        <div class="editor-area">
            <div id="editor" class="preservar-espacamento">
                ...
                <p style="text-align: justify; line-height: 1.5;">
                    Cumprimentando-o cordialmente, solicito a V. Exª a realização de <strong>PERÍCIA PAPILOSCÓPICA</strong> no(s) seguinte(s) objeto(s) apreendido(s) e vinculado(s) ao presente Boletim de Ocorrência:
                </p>
                
                <div style="height: 12px;"></div>
                
                <p style="text-align: justify; line-height: 1.5; margin-left: 30px;">
                    <strong>[DESCREVER OS OBJETOS AQUI]</strong>
                </p>
